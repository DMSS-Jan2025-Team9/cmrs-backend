...
public class ClassScheduleServiceImpl implements ClassScheduleService {
    ...
    public ClassSchedule addClassSchedule(ClassSchedule classSchedule) {
        if (classScheduleRepository.existsByCourse_CourseIdAndDayOfWeekAndStartTimeAndEndTime(
                classSchedule.getCourse().getCourseId(), classSchedule.getDayOfWeek(), classSchedule.getStartTime(),
     ...
     * @param existingCapacity For edits, the existing capacity to subtract from
     *                         total
