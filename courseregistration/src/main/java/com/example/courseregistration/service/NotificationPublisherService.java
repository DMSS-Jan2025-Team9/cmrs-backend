...
public class NotificationPublisherService {
    ...
    public void publishWaitlistNotification(Long studentId, CourseClassDTO courseClass) {
        ...
        logger.debug("Publishing waitlist notification for student {} and class {}", studentId,
        ...
        rabbitTemplate.convertAndSend(
                ...
                event);
        logger.info("Waitlist notification published for student {} and course {}", studentId, courseCode);
    }

    public void publishVacancyAvailableNotification(Long studentId, CourseClassDTO courseClass) {
        // Verify course details are available
        logger.debug("Publishing vacancy notification for student {} and class {}", studentId,
                courseClass.getClassId());
        ...
        rabbitTemplate.convertAndSend(
                ...
                event);
        logger.info("Vacancy notification published for student {} and course {}", studentId, courseCode);
    }
}